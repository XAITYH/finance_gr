        ...
        <div className={styles.registrationWindow}>
            ...
            <form className={styles.form}>
                <label for="nickname" className={styles.NameItem}>Имя пользователя</label>
                    <input className={styles.fillItem} type="text" name="nickname" placeholder="Введите имя пользователя"/>
                <label for="email" className={styles.NameItem}>E-mail</label>
                    <input className={styles.fillItem} type="email" name="email" placeholder="Введите E-mail"/>
                <label for="password" className={styles.NameItem}>Пароль</label>
                    <input className={styles.fillItem} type="password" name="password" placeholder="Введите пароль"/>
                    <label for="repeatPassword" className={styles.NameItem}>Повторите пароль</label>
                    <input className={styles.fillItem} type="password" name="repeatPassword" placeholder="Повторите пароль"/>
