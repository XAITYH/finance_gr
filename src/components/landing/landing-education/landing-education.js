    ...
    <div className={styles.educationWrapper}>
        <div className={styles.edObjects}>
            ...
            <p className={styles.ourProgram}>
                Обучение должно быть комфортным. Поэтому мы разработали собственную платформу для обучения программированию. 
                На ней вы можете не только изучать теорию, но и запускать готовые примеры и даже писать свой собственный код.
            </p>
            ...
            <div className={styles.top3}>
                <div className={styles.top}>
                    ...
                    <h2 className={styles.title}>Весь материал разбит на небольшие уроки</h2>
                    <p className={styles.description1}>
                        Теория и практика подаются маленькими порциями. 
                        Так вам будет легче усваивать новые знания.
                    </p>
                </div>
                <div className={styles.top}>
                    ...
                    <p className={styles.description2}>
                        Всё, что вы узнали, вы тут же начинаете применять на практике. 
                        Вы сразу видите результаты своего труда.
                    </p>
                </div>
                <div className={styles.top}>
                    ...
                    <p className={styles.description3}> 
                        Можно совмещать учёбу с работой и другими дeлами. 
                        Не нужно выпрашивать академический отпуск, если пришлось сделать перерыв.
                    </p>
                </div>
            </div>
            <div className={styles.startEducation}>
                <LandingButton width={249} height={70}>Начать обучение</LandingButton>
                <p className={styles.testStartText}>Попробуйте, первые уроки бесплатны, но нужно пройти тестирование</p>
            </div>
        </div>
    </div>
    );
